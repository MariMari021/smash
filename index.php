...
<style type="text/css">
    ...
    .form-control:focus {
        border-color:
            <?php echo $cor_sistema ?>
            -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, .075), 0 0 2px
            <?php echo $cor_sistema ?>
        ;
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        for ($i = 0; $i < $total_reg; $i++) {
                            ...
                            <div class="item <?php echo $active ?>">
                                <div class="carousel-background"><img src="sistema/img/banners/<?php echo $imagem ?>" alt="">
                                </div>
        ...
        <div class="container">
            ...
            <div class="row wow fadeInUp">
                <div class="col-md-6 about-img">
                    ...
                    <?php } else { ?>
                        <iframe class="video-mobile" width="100%" height="320px" src="<?php echo $video_sobre ?>"
                            frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                            allowfullscreen id=""></iframe>
                    <?php } ?>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-offset-2 col-md-8">
                        <div class="section-heading">
                            <h2>
                                <?php echo $titulo_servicos ?>
                            </h2>
                            <div class="heading-line"></div>
                            <p>
                                <?php echo $subtitulo_servicos ?>
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div id="carousel-service" class="service carousel slide">
                                            ...
                                            <div class="col-sm-12 col-md-5">
                                                <div class="screenshot wow bounceInRight">
                                                    <?php if ($exibir == 'Imagem') { ?>
                                                        <img src="sistema/img/servicos/<?php echo $imagem ?>" class="img-responsive"
                                                            alt="" />
                                                    <?php } else { ?>
                                                        <iframe class="video-mobile" width="100%" height="320px"
                            ...
                            <ol class="carousel-indicators">
                                ...
                                for ($i = 0; $i < $total_reg; $i++) {
                                    ...
                                    ?>
                                    <li data-target="#carousel-service" data-slide-to="<?php echo $i ?>"
                                        class="<?php echo $active ?>" onclick="new WOW().init();"></li>
                                <?php } ?>
                ...
                <div class="row">
                    <div class="col-md-offset-2 col-md-8">
                        <div class="section-heading" style="margin-top: -100px">
                            <h2>
                                <?php echo $titulo_trabalhos ?>
                            </h2>
                            <div class="heading-line"></div>
                            <p>
                                <?php echo $subtitulo_trabalhos ?>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <ul id="og-grid" class="og-grid">
                            ...
                            for ($i = 0; $i < $total_reg; $i++) {
                                ...
                                ?>
                                <li>
                                    <a href="<?php echo $link ?>" data-largesrc="sistema/img/trabalhos/<?php echo $imagem ?>"
                                        data-title="<?php echo $titulo ?>" data-description="<?php echo $descricao ?>"
                                        onclick="chamarImg('<?php echo $exibir ?>', '<?php echo $video ?>')">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-offset-2 col-md-8">
                        <div class="section-heading" style="margin-top: -100px">
                            <h2>
                                <?php echo $titulo_equipe ?>
                            </h2>
                            <div class="heading-line"></div>
                            <p>
                                <?php echo $subtitulo_equipe ?>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-offset-2 col-md-8">
                    <div class="section-heading" style="margin-top: -100px">
                        <h2>
                            <?php echo $titulo_contato ?>
                        </h2>
                        <div class="heading-line"></div>
                        <p>
                            <?php echo $subtitulo_contato ?>
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-offset-2 col-md-8">
                            <div class="form-group">
                                <input type="text" name="nome" class="form-control" id="name" placeholder="Seu Nome"
                                    data-rule="minlen:4" data-msg="Pelo menos 4 caracteres" />
                        ...
                        <div class="col-md-offset-2 col-md-8">
                            <div class="form-group">
                                <input type="email" class="form-control" name="email" id="email" placeholder="Seu Email"
                                    data-rule="email" data-msg="Insira um email válido" />
                                <div class="validation"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-offset-2 col-md-8">
                            <div class="form-group">
                                <textarea class="form-control" name="mensagem" rows="5" data-rule="required"
                                    data-msg="Insira sua Mensagem" placeholder="Messagem"></textarea>
                                <div class="validation"></div>
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <div class="row" style="margin-top: -70px">
                ...
                <div class="<?php echo $colunas ?>">
                    <div class="contact-widget wow bounceInUp">
                        <a target="_blank"
                            href="http://api.whatsapp.com/send?1=pt_BR&phone=<?php echo $whatsapp_sistema ?>"
                            class="link-neutro"><i class="fa fa-phone fa-4x"></i>
                            <h5>Telefone / Whatsapp</h5>
                        </a>
                        <p>
                            <a target="_blank"
                                href="http://api.whatsapp.com/send?1=pt_BR&phone=<?php echo $whatsapp_sistema ?>"
                                class="link-neutro" style="color:#2e2e2e">
